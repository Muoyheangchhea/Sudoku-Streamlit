...
st.set_page_config(page_title="Play Sudoku: Classic Mode", page_icon="🎮")
...
def main():
    st.title("Sudoku Game: Classic Mode")

    board_input = st.session_state.board_input

    st.sidebar.subheader("Introduction")
    st.sidebar.write(
    '''This is Sudoku Classic Game Mode.
    In this mode, you can practice solving Sudoku Game by using your own skills.             
    ''')
    ...
    3. There is no hints or show all answers function
